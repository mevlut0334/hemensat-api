...
class SaleListingFilterRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => 'nullable|in:draft,active,sold,inactive',
            ...
            // Sorting
            'sort_by' => 'nullable|in:created_at,updated_at,published_at,highest_offer_price,total_offers_count,last_offer_at',
    ...
    public function messages(): array
    {
        return [
            ...
            'storage_capacity_id.exists' => 'Seçilen depolama kapasitesi bulunamadı.',
            'purchase_source_id.exists' => 'Seçilen satın alma kaynağı bulunamadı.',
