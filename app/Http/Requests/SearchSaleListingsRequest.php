...
class SearchSaleListingsRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "query.required" => "Arama sorgusu gereklidir.",
            "query.min" => "Arama sorgusu en az 2 karakter olmalıdır.",
            "query.max" => "Arama sorgusu en fazla 100 karakter olabilir.",
